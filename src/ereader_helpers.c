    ...
    [0] = {
        ...
        .mons = {
            ...
            [3] = {
                ...
                .moves = { MOVE_GUNK_SHOT, MOVE_SHADOW_BALL, MOVE_PAIN_SPLIT, MOVE_YAWN },
                .hpEV = 55,
                .attackEV = 255,
                .defenseEV = 100,
                .speedEV = 0,
            ...
            [4] = {
                ...
                .moves = { MOVE_SILVER_WIND, MOVE_GUNK_SHOT, MOVE_SHADOW_BALL, MOVE_GIGA_DRAIN },
                .hpEV = 0,
                .attackEV = 255,
                .defenseEV = 0,
                .speedEV = 0,
    ...
    [1] = {
        ...
        .mons = {
            ...
            [4] = {
                ...
                .heldItem = ITEM_BRIGHT_POWDER,
                .moves = { MOVE_FACADE, MOVE_BLADE_FLASH, MOVE_QUICK_ATTACK, MOVE_SHADOW_HIT },
                .hpEV = 255,
                .attackEV = 255,
                .defenseEV = 0,
                .speedEV = 0,
    ...
    [2] = {
        ...
        .mons = {
            ...
            [5] = {
                ...
                .heldItem = ITEM_BRIGHT_POWDER,
                .moves = { MOVE_SILVER_WIND, MOVE_BLADE_FLASH, MOVE_ATTRACT, MOVE_MANA_BURST },
                .hpEV = 100,
                .attackEV = 200,
                .defenseEV = 0,
                .speedEV = 0,
    ...
    [3] = {
        ...
        .mons = {
            ...
            [4] = {
                ...
                .moves = { MOVE_SURF, MOVE_CRUNCH, MOVE_HEAD_SMASH, MOVE_EARTHQUAKE },
                .hpEV = 255,
                .attackEV = 0,
                .defenseEV = 0,
                .speedEV = 0,
