...
static const struct TrainerHillTrainer sTrainerHillTrainerTemplates_JP[] = {
    ...
    [1] = {
        ...
        .mons = {
            ...
            [4] = {
                ...
                .heldItem = ITEM_BRIGHT_POWDER,
                .moves = { MOVE_FACADE, MOVE_BLADE_FLASH, MOVE_QUICK_ATTACK, MOVE_DOUBLE_TEAM },
                .hpEV = 255,
                .attackEV = 255,
                .defenseEV = 0,
                .speedEV = 0,
    ...
    [2] = {
        ...
        .speechWin = { EC_WORD_SHINE, EC_WORD_POKEMON, EC_WORD_TO_HER, EC_MOVE2(PRANK), EC_WORD_KNOWS, EC_WORD_WITHOUT },
