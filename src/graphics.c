...
// fr_tm_case_port
const u32 gTMCase_Menu_Gfx[] = INCBIN_U32("graphics/tm_case/unk_8E845D8.4bpp.lz");
const u32 gTMCase_Menu_Tilemap[] = INCBIN_U32("graphics/tm_case/unk_8E84A24.bin.lz");
const u32 gTMCase_MenuPaletteMale[] = INCBIN_U32("graphics/tm_case/menu_male.gbapal.lz");
const u32 gTMCase_MenuPaletteFemale[] = INCBIN_U32("graphics/tm_case/menu_female.gbapal.lz");
const u8 gTMCase_HMIconGfx[] = INCBIN_U8("graphics/tm_case/hm.4bpp");
