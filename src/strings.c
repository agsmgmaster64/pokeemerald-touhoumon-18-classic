...
const u8 gText_UnkHeight[] = _("???.?");
const u8 gText_UnkWeight[] = _("???.? m");
...
const u8 gText_Flute[] = _("Played the Toho Flute.");
const u8 gText_FluteAwaken[] = _("The Toho Flute awakened sleeping\nPuppets.{PAUSE_UNTIL_PRESS}");
const u8 gText_FluteCatchyTune[] = _("Played the Toho Flute.\pNow, that's a catchy tune!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_ThrowInPremierBall[] = _("I'll throw in a Preimer Orb, too.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_MoveItemsDescription[] = _("Move items held by any Puppet\nin a Box or your party.");
...
const u8 gText_CheckPokemonInDetail[] = _("Check Puppet in detail.");
...
const u8 gText_VenusaurDoll256BP[] = _("CALICE DOLL{CLEAR_TO 0x58}256BP");
...
const u8 gText_MatchCallBrendan_Intro1[] = _("I'll be a better Puppet");
