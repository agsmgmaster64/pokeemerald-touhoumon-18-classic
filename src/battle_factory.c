...
{
    MOVE_SWORDS_DANCE, MOVE_GROWTH, MOVE_ZEN_HEADBUTT, MOVE_AGILITY, MOVE_SHADOW_HIT, MOVE_HARDEN,
    ...
    MOVE_BATTERY_CHARGE, MOVE_SNATCH, MOVE_MANA_CHARGE, MOVE_DRACO_METEOR, MOVE_IRON_DEFENSE, MOVE_HOWL, MOVE_BULK_UP, MOVE_CALM_MIND, MOVE_TAILWIND,
    MOVE_NONE
};
...
static const u16 sMoves_WeakeningTheFoe[] =
{
    ...
    MOVE_FLASH, MOVE_COTTON_SPORE, MOVE_SPITE, MOVE_SCARY_FACE, MOVE_SMILE, MOVE_BRAVER, MOVE_NATURE_POWER, MOVE_ROOST,
...
{
    MOVE_JUDGEMENT, MOVE_SCULPTURE, MOVE_HEAD_SMASH, MOVE_HYPER_BEAM, MOVE_COUNTER, MOVE_FISSURE,
...
static const u16 sMoves_Endurance[] =
{
    ...
    MOVE_MUD_SLAP, MOVE_SLACK_OFF, MOVE_AROMATHERAPY, MOVE_SPLASHING,
    MOVE_NONE
};
