...
const u8 *const gMonIconTable[] =
{
    ...
    [SPECIES_CSANAE] = gMonIcon_Bulbasaur,
    [SPECIES_SANAE] = gMonIcon_Ivysaur,
    [SPECIES_CALICE] = gMonIcon_Venusaur,
    [SPECIES_ALICE] = gMonIcon_Charmander,
    [SPECIES_CREISEN] = gMonIcon_Charmeleon,
    [SPECIES_REISEN] = gMonIcon_Charizard,
    [SPECIES_CLILYWHITE] = gMonIcon_Squirtle,
    [SPECIES_LILYWHITE] = gMonIcon_Wartortle,
    [SPECIES_CLILYBLACK] = gMonIcon_Blastoise,
    [SPECIES_LILYBLACK] = gMonIcon_Caterpie,
    [SPECIES_CMOMIJI] = gMonIcon_Metapod,
    [SPECIES_MOMIJI] = gMonIcon_Butterfree,
    [SPECIES_CSHIZUHA] = gMonIcon_Weedle,
    [SPECIES_SHIZUHA] = gMonIcon_Kakuna,
    [SPECIES_CMEDICINE] = gMonIcon_Beedrill,
    [SPECIES_MEDICINE] = gMonIcon_Pidgey,
    [SPECIES_CKOAKUMA] = gMonIcon_Pidgeotto,
    [SPECIES_KOAKUMA] = gMonIcon_Pidgeot,
    [SPECIES_CNAZRIN] = gMonIcon_Rattata,
    [SPECIES_NAZRIN] = gMonIcon_Raticate,
    [SPECIES_CTOKIKO] = gMonIcon_Spearow,
    [SPECIES_TOKIKO] = gMonIcon_Fearow,
    [SPECIES_CREMILIA] = gMonIcon_Ekans,
    [SPECIES_REMILIA] = gMonIcon_Arbok,
    [SPECIES_CCIRNO] = gMonIcon_Pikachu,
    ...
    [SPECIES_CYOUMU] = gMonIcon_Nidorino,
