...
static const u8 sText_PkmnMakesGroundMiss[] = _("{B_DEF_NAME_WITH_PREFIX} makes Earth\nmoves miss with {B_DEF_ABILITY}!");
...
static const u8 sText_PkmnHidUnderwater[] = _("{B_ATK_NAME_WITH_PREFIX} dipped into\nthe shadows!");
...
static const u8 sText_PkmnUproarKeptAwake[] = _("But {B_SCR_ACTIVE_NAME_WITH_PREFIX}'s Performance\nkept it awake!");
static const u8 sText_PkmnWokeUpInUproar[] = _("{B_ATK_NAME_WITH_PREFIX} woke up\nin the Performance!");
static const u8 sText_PkmnCausedUproar[] = _("{B_ATK_NAME_WITH_PREFIX} made\na Performance!");
...
static const u8 sText_PkmnCantSleepInUproar2[] = _("But {B_DEF_NAME_WITH_PREFIX} can't\nsleep in an Performance!");
static const u8 sText_UproarKeptPkmnAwake[] = _("But the Performance kept\n{B_DEF_NAME_WITH_PREFIX} awake!");
...
static const u8 sText_PkmnsXWhippedUpHailstorm[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nwhipped up a hailstorm!"); // corresponds to DownpourText in pokegold and pokecrystal and is used by Rain Dance in GSC
...
static const u8 sText_ItDodgedBall[] = _("It dodged the thrown Orb!\nThis Puppet can't be caught!");
static const u8 sText_YouMissedPkmn[] = _("You missed the Puppet!");
...
const u16 gMoveWeatherChangeStringIds[] =
{
    ...
    [B_MSG_STARTED_DOWNPOUR]  = STRINGID_PKMNSXWHIPPEDUPHAILSTORM, // Unused
...
const u8 gText_SafariZoneMenu[] = _("Orb{CLEAR_TO 56}{POKEBLOCK}\nGo Near{CLEAR_TO 56}Run");
const u8 gText_MoveInterfacePP[] = _("PP ");
const u8 gText_MoveInterfacePhysical[] = _("Phys/");
const u8 gText_MoveInterfaceSpecial[] = _("Spec/");
const u8 gText_MoveInterfaceStatus[] = _("Stat/");
...
const u8 gText_SafariBalls[] = _("{HIGHLIGHT DARK_GRAY}Safari Orbs");
...
static const u16 sGrammarMoveUsedTable[] =
{
    ...
    MOVE_DISPERSE, MOVE_BONEMERANG, MOVE_REST, MOVE_SHARPEN,
    ...
    MOVE_CAMOUFLAGE, MOVE_ASTONISH, MOVE_SHADOW_HIT,
    ...
    MOVE_ZEN_HEADBUTT, MOVE_AGILITY, MOVE_MIMIC, MOVE_DOUBLE_TEAM,
    MOVE_BARRAGE, MOVE_TRANSFORM, MOVE_STRUGGLE, MOVE_SCARY_FACE,
    MOVE_BATT_CHARGE, MOVE_WISH, MOVE_BRICK_BREAK, MOVE_YAWN,
    MOVE_ROOST, MOVE_TEETER_DANCE, MOVE_EARTH_POWER,
    MOVE_FAKE_TEARS, MOVE_SPLASHING, MOVE_CALM_MIND, 0,

    MOVE_POUND, MOVE_SCRATCH, MOVE_NIGHT_SLASH,
    MOVE_WING_ATTACK, MOVE_FLY, MOVE_BIND, MOVE_POWER_WHIP,
