...
const u8 gTypeEffectiveness[288] =
{
    ...
    TYPE_FIRE, TYPE_ROCK, TYPE_MUL_SUPER_EFFECTIVE,
    ...
    TYPE_FIGHTING, TYPE_FIGHTING, TYPE_MUL_SUPER_EFFECTIVE,
    ...
    TYPE_FIGHTING, TYPE_BUG, TYPE_MUL_SUPER_EFFECTIVE,
    ...
    TYPE_POISON, TYPE_PSYCHIC, TYPE_MUL_NOT_EFFECTIVE,
    ...
    TYPE_GROUND, TYPE_ROCK, TYPE_MUL_NOT_EFFECTIVE,
    ...
    TYPE_FLYING, TYPE_ROCK, TYPE_MUL_SUPER_EFFECTIVE,
    ...
    TYPE_PSYCHIC, TYPE_DRAGON, TYPE_MUL_SUPER_EFFECTIVE,
    ...
    TYPE_BUG, TYPE_BUG, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_BUG, TYPE_DRAGON, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_BUG, TYPE_DARK, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_ROCK, TYPE_GRASS, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_ROCK, TYPE_FLYING, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_ROCK, TYPE_GHOST, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_ROCK, TYPE_DRAGON, TYPE_MUL_SUPER_EFFECTIVE,
    ...
    TYPE_GHOST, TYPE_ROCK, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_GHOST, TYPE_GHOST, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GHOST, TYPE_DARK, TYPE_MUL_NO_EFFECT,
    TYPE_DRAGON, TYPE_POISON, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_DRAGON, TYPE_PSYCHIC, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_DRAGON, TYPE_BUG, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_DRAGON, TYPE_DARK, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_DARK, TYPE_FIGHTING, TYPE_MUL_SUPER_EFFECTIVE,
    ...
    TYPE_STEEL, TYPE_FLYING, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_STEEL, TYPE_DARK, TYPE_MUL_SUPER_EFFECTIVE,
...
{
    [TYPE_NORMAL] = _("Illusn"),
    [TYPE_FIGHTING] = _("Dream"),
    [TYPE_FLYING] = _("Flying"),
    [TYPE_POISON] = _("Miasma"),
    [TYPE_GROUND] = _("Earth"),
    [TYPE_ROCK] = _("Beast"),
    [TYPE_BUG] = _("Heart"),
    [TYPE_GHOST] = _("Ghost"),
    ...
    [TYPE_WATER] = _("Water"),
    [TYPE_GRASS] = _("Nature"),
    [TYPE_ELECTRIC] = _("Wind"),
    [TYPE_PSYCHIC] = _("Reason"),
    [TYPE_ICE] = _("Ice"),
    [TYPE_DRAGON] = _("Faith"),
    [TYPE_DARK] = _("Dark"),
};
            ...
            if (!(gBattleControllerExecFlags & ((gBitTable[gActiveBattler]) | (0xF << 28) | (gBitTable[gActiveBattler] << 4) | (gBitTable[gActiveBattler] << 8) | (gBitTable[gActiveBattler] << 12))))
            {
                ...
                case B_ACTION_SWITCH:
                    *(gBattleStruct->battlerPartyIndexes + gActiveBattler) = gBattlerPartyIndexes[gActiveBattler];
                    ...
                    else if ((i = ABILITY_ON_OPPOSING_FIELD(gActiveBattler, ABILITY_ARENA_TRAP))
