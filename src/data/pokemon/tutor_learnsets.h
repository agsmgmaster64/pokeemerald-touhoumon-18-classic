...
static const u32 sTutorLearnsets[] =
{
    ...
    [SPECIES_BUTTERFREE]       = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
    ...
    [SPECIES_PIDGEY]           = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_SNORE)
                                | TUTOR(MOVE_ENDURE)
    ...
    [SPECIES_PIDGEOTTO]        = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_SNORE)
                                | TUTOR(MOVE_ENDURE)
    ...
    [SPECIES_PIDGEOT]          = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_SNORE)
                                | TUTOR(MOVE_ENDURE)
    ...
    [SPECIES_SPEAROW]          = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_SNORE)
                                | TUTOR(MOVE_ENDURE)
    ...
    [SPECIES_FEAROW]           = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_SNORE)
                                | TUTOR(MOVE_ENDURE)
    ...
    [SPECIES_ZUBAT]            = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_SNORE)
                                | TUTOR(MOVE_ENDURE)
    ...
    [SPECIES_GOLBAT]           = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_SNORE)
                                | TUTOR(MOVE_ENDURE)
    ...
    [SPECIES_VENONAT]          = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_SNORE)
                                | TUTOR(MOVE_ENDURE)
    ...
    [SPECIES_VENOMOTH]         = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_SNORE)
                                | TUTOR(MOVE_ENDURE)
    ...
    [SPECIES_MAGNEMITE]        = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_THUNDER_WAVE)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_TREMORS)
    ...
    [SPECIES_MAGNETON]         = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_THUNDER_WAVE)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_TREMORS)
    ...
    [SPECIES_SHELLDER]         = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_EXPLOSION)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_SNORE)
    ...
    [SPECIES_CLOYSTER]         = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_EXPLOSION)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_SNORE)
    ...
    [SPECIES_EXEGGCUTE]        = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_DREAM_EATER)
                                | TUTOR(MOVE_EXPLOSION)
                                | TUTOR(MOVE_SUBSTITUTE)
    ...
    [SPECIES_EXEGGUTOR]        = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_DREAM_EATER)
                                | TUTOR(MOVE_EXPLOSION)
                                | TUTOR(MOVE_SUBSTITUTE)
    ...
    [SPECIES_HORSEA]           = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_SNORE)
                                | TUTOR(MOVE_ICY_WIND)
    ...
    [SPECIES_SEADRA]           = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_SNORE)
                                | TUTOR(MOVE_ICY_WIND)
    ...
    [SPECIES_GOLDEEN]          = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_SNORE)
                                | TUTOR(MOVE_ICY_WIND)
    ...
    [SPECIES_SEAKING]          = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_SNORE)
                                | TUTOR(MOVE_ICY_WIND)
    ...
    [SPECIES_STARYU]           = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_THUNDER_WAVE)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_PSYCH_UP)
    ...
    [SPECIES_STARMIE]          = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_DREAM_EATER)
                                | TUTOR(MOVE_THUNDER_WAVE)
                                | TUTOR(MOVE_SUBSTITUTE)
    ...
    [SPECIES_PORYGON]          = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_DREAM_EATER)
                                | TUTOR(MOVE_THUNDER_WAVE)
                                | TUTOR(MOVE_SUBSTITUTE)
    ...
    [SPECIES_AERODACTYL]       = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_ROCK_WRECKER)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_SNORE)
    ...
    [SPECIES_ARTICUNO]         = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_SNORE)
                                | TUTOR(MOVE_ICY_WIND)
    ...
    [SPECIES_ZAPDOS]           = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_THUNDER_WAVE)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_SNORE)
    ...
    [SPECIES_MOLTRES]          = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_SNORE)
                                | TUTOR(MOVE_ENDURE)
    ...
    [SPECIES_HOOTHOOT]         = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_DREAM_EATER)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_SNORE)
    ...
    [SPECIES_NOCTOWL]          = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_DREAM_EATER)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_SNORE)
    ...
    [SPECIES_CROBAT]           = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_SNORE)
                                | TUTOR(MOVE_ENDURE)
    ...
    [SPECIES_CHINCHOU]         = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_THUNDER_WAVE)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_SNORE)
    ...
    [SPECIES_LANTURN]          = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_THUNDER_WAVE)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_SNORE)
    ...
    [SPECIES_NATU]             = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_DREAM_EATER)
                                | TUTOR(MOVE_THUNDER_WAVE)
                                | TUTOR(MOVE_SUBSTITUTE)
    ...
    [SPECIES_XATU]             = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_DREAM_EATER)
                                | TUTOR(MOVE_THUNDER_WAVE)
                                | TUTOR(MOVE_SUBSTITUTE)
    ...
    [SPECIES_YANMA]            = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_DREAM_EATER)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_SNORE)
    ...
    [SPECIES_MURKROW]          = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_DREAM_EATER)
                                | TUTOR(MOVE_THUNDER_WAVE)
                                | TUTOR(MOVE_SUBSTITUTE)
    ...
    [SPECIES_MISDREAVUS]       = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_DREAM_EATER)
                                | TUTOR(MOVE_THUNDER_WAVE)
                                | TUTOR(MOVE_SUBSTITUTE)
    ...
    [SPECIES_REMORAID]         = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_THUNDER_WAVE)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_SNORE)
    ...
    [SPECIES_OCTILLERY]        = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_SEISMIC_TOSS)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_THUNDER_WAVE)
                                | TUTOR(MOVE_SUBSTITUTE)
    ...
    [SPECIES_SKARMORY]         = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_COUNTER)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_ROCK_WRECKER)
                                | TUTOR(MOVE_SUBSTITUTE)
    ...
    [SPECIES_PORYGON2]         = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_DREAM_EATER)
                                | TUTOR(MOVE_THUNDER_WAVE)
                                | TUTOR(MOVE_SUBSTITUTE)
    ...
    [SPECIES_HO_OH]            = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_DREAM_EATER)
                                | TUTOR(MOVE_THUNDER_WAVE)
                                | TUTOR(MOVE_SUBSTITUTE)
    ...
    [SPECIES_BEAUTIFLY]        = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_SNORE)
                                | TUTOR(MOVE_ENDURE)
    ...
    [SPECIES_DUSTOX]           = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_SNORE)
                                | TUTOR(MOVE_ENDURE)
    ...
    [SPECIES_NINCADA]          = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_SNORE)
                                | TUTOR(MOVE_ENDURE)
    ...
    [SPECIES_SHEDINJA]         = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_DREAM_EATER)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_SNORE)
    ...
    [SPECIES_TAILLOW]          = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_COUNTER)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_SNORE)
    ...
    [SPECIES_SWELLOW]          = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_COUNTER)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_SNORE)
    ...
    [SPECIES_WINGULL]          = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_SNORE)
                                | TUTOR(MOVE_ICY_WIND)
    ...
    [SPECIES_PELIPPER]         = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_SNORE)
                                | TUTOR(MOVE_ICY_WIND)
    ...
    [SPECIES_SURSKIT]          = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_PSYCH_UP)
                                | TUTOR(MOVE_SNORE)
    ...
    [SPECIES_MASQUERAIN]       = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_PSYCH_UP)
                                | TUTOR(MOVE_SNORE)
    ...
    [SPECIES_BALTOY]           = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_DREAM_EATER)
                                | TUTOR(MOVE_EXPLOSION)
                                | TUTOR(MOVE_ROCK_WRECKER)
    ...
    [SPECIES_CLAYDOL]          = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_DREAM_EATER)
                                | TUTOR(MOVE_EXPLOSION)
                                | TUTOR(MOVE_ROCK_WRECKER)
    ...
    [SPECIES_BARBOACH]         = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_SNORE)
                                | TUTOR(MOVE_ICY_WIND)
    ...
    [SPECIES_WHISCASH]         = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_ROCK_WRECKER)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_SNORE)
    ...
    [SPECIES_LUVDISC]          = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_PSYCH_UP)
                                | TUTOR(MOVE_SNORE)
    ...
    [SPECIES_FEEBAS]           = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_SNORE)
                                | TUTOR(MOVE_ICY_WIND)
    ...
    [SPECIES_CARVANHA]         = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_SNORE)
                                | TUTOR(MOVE_ICY_WIND)
    ...
    [SPECIES_SHARPEDO]         = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_SNORE)
                                | TUTOR(MOVE_ICY_WIND)
    ...
    [SPECIES_CHIMECHO]         = (TUTOR(MOVE_HEAD_SMASH)
                                | TUTOR(MOVE_MIMIC)
                                | TUTOR(MOVE_DREAM_EATER)
                                | TUTOR(MOVE_SUBSTITUTE)
                                | TUTOR(MOVE_TREMORS)
