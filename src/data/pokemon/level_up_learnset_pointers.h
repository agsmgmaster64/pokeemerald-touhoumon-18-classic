const u16 *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    [SPECIES_CATERPIE] = sLilyBlackLevelUpLearnset,
    [SPECIES_METAPOD] = sCMomijiLevelUpLearnset,
    [SPECIES_BUTTERFREE] = sMomijiLevelUpLearnset,
    [SPECIES_WEEDLE] = sCShizuhaLevelUpLearnset,
    [SPECIES_KAKUNA] = sShizuhaLevelUpLearnset,
    [SPECIES_BEEDRILL] = sCMedicineLevelUpLearnset,
    [SPECIES_PIDGEY] = sMedicineLevelUpLearnset,
    [SPECIES_PIDGEOTTO] = sCKoakumaLevelUpLearnset,
    [SPECIES_PIDGEOT] = sKoakumaLevelUpLearnset,
    [SPECIES_RATTATA] = sCNazrinLevelUpLearnset,
    [SPECIES_RATICATE] = sNazrinLevelUpLearnset,
    [SPECIES_SPEAROW] = sCTokikoLevelUpLearnset,
    [SPECIES_FEAROW] = sTokikoLevelUpLearnset,
    [SPECIES_EKANS] = sCRemiliaLevelUpLearnset,
    [SPECIES_ARBOK] = sRemiliaLevelUpLearnset,
    [SPECIES_PIKACHU] = sCCirnoLevelUpLearnset,
    [SPECIES_RAICHU] = sCirnoLevelUpLearnset,
    [SPECIES_SANDSHREW] = sCRumiaLevelUpLearnset,
    [SPECIES_SANDSLASH] = sRumiaLevelUpLearnset,
    [SPECIES_NIDORAN_F] = sShanghaiLevelUpLearnset,
    [SPECIES_NIDORINA] = sCFlandreLevelUpLearnset,
    [SPECIES_NIDOQUEEN] = sFlandreLevelUpLearnset,
    [SPECIES_NIDORAN_M] = sHouraiLevelUpLearnset,
    [SPECIES_NIDORINO] = sCYoumuLevelUpLearnset,
    [SPECIES_NIDOKING] = sYoumuLevelUpLearnset,
    [SPECIES_CLEFAIRY] = sCYukariLevelUpLearnset,
    [SPECIES_CLEFABLE] = sYukariLevelUpLearnset,
