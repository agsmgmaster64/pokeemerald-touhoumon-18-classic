const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_PIKACHU]    = {{EVO_ITEM, ITEM_SWIFT_SHARD, SPECIES_RAICHU}},
    [SPECIES_SANDSHREW]  = {{EVO_LEVEL, 22, SPECIES_SANDSLASH}},
    [SPECIES_NIDORAN_F]  = {{EVO_LEVEL, 16, SPECIES_NIDORINA}},
    [SPECIES_NIDORINA]   = {{EVO_ITEM, ITEM_POWER_SHARD, SPECIES_NIDOQUEEN}},
    [SPECIES_NIDORAN_M]  = {{EVO_LEVEL, 16, SPECIES_NIDORINO}},
    [SPECIES_NIDORINO]   = {{EVO_ITEM, ITEM_POWER_SHARD, SPECIES_NIDOKING}},
    [SPECIES_CLEFAIRY]   = {{EVO_ITEM, ITEM_POWER_SHARD, SPECIES_CLEFABLE}},
    [SPECIES_VULPIX]     = {{EVO_ITEM, ITEM_DEFENSE_SHARD, SPECIES_NINETALES}},
    [SPECIES_JIGGLYPUFF] = {{EVO_ITEM, ITEM_POWER_SHARD, SPECIES_WIGGLYTUFF}},
    ...
    [SPECIES_GLOOM]      = {{EVO_ITEM, ITEM_HELPER_SHARD, SPECIES_VILEPLUME},
                            {EVO_ITEM, ITEM_SOLAR_SHARD, SPECIES_BELLOSSOM}},
