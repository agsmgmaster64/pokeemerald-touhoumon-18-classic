...
{
    [SPECIES_CSANAE]     = {{EVO_LEVEL, 36, SPECIES_SANAE},
                            {EVO_ITEM, ITEM_TECH_SHARD, SPECIES_ELECTRIKE},
                            {EVO_ITEM, ITEM_POWER_SHARD, SPECIES_MANECTRIC}},
    [SPECIES_CALICE]     = {{EVO_LEVEL, 36, SPECIES_ALICE},
                            {EVO_ITEM, ITEM_POWER_SHARD, SPECIES_MARSHTOMP},
                            {EVO_ITEM, ITEM_TECH_SHARD, SPECIES_SWAMPERT},
                            {EVO_ITEM, ITEM_SOLAR_SHARD, SPECIES_BELDUM}},
    [SPECIES_CREISEN]    = {{EVO_LEVEL, 36, SPECIES_REISEN},
                            {EVO_ITEM, ITEM_DEFENSE_SHARD, SPECIES_SHUCKLE},
                            {EVO_ITEM, ITEM_TECH_SHARD, SPECIES_HERACROSS},
                            {EVO_ITEM, ITEM_SOLAR_SHARD, SPECIES_GOREBYSS}},
    [SPECIES_CLILYWHITE] = {{EVO_LEVEL, 25, SPECIES_LILYWHITE}},
    [SPECIES_CLILYBLACK] = {{EVO_LEVEL, 25, SPECIES_LILYBLACK}},
    [SPECIES_CMOMIJI]    = {{EVO_LEVEL, 28, SPECIES_MOMIJI}},
    [SPECIES_CSHIZUHA]   = {{EVO_LEVEL, 25, SPECIES_SHIZUHA}},
    [SPECIES_CMEDICINE]  = {{EVO_LEVEL, 25, SPECIES_MEDICINE}},
    [SPECIES_CKOAKUMA]   = {{EVO_LEVEL, 28, SPECIES_KOAKUMA},
                            {EVO_ITEM, ITEM_HELPER_SHARD, SPECIES_OCTILLERY}},
    [SPECIES_CNAZRIN]    = {{EVO_LEVEL, 25, SPECIES_NAZRIN}},
    [SPECIES_CTOKIKO]    = {{EVO_LEVEL, 25, SPECIES_TOKIKO}},
    [SPECIES_CREMILIA]   = {{EVO_LEVEL, 38, SPECIES_REMILIA}},
    [SPECIES_CCIRNO]     = {{EVO_LEVEL, 28, SPECIES_CIRNO}},
    [SPECIES_SANDSHREW]  = {{EVO_LEVEL, 34, SPECIES_SANDSLASH}},
    [SPECIES_NIDORAN_F]  = {{EVO_LEVEL, 25, SPECIES_NIDORINA}},
    [SPECIES_NIDORINA]   = {{EVO_LEVEL, 40, SPECIES_NIDOQUEEN}},
    [SPECIES_NIDORAN_M]  = {{EVO_LEVEL, 25, SPECIES_CYOUMU}},
    [SPECIES_CYOUMU]     = {{EVO_LEVEL, 36, SPECIES_YOUMU},
                            {EVO_ITEM, ITEM_DEFENSE_SHARD, SPECIES_REMORAID},
                            {EVO_ITEM, ITEM_SWIFT_SHARD, SPECIES_OCTILLERY}},
    [SPECIES_CLEFAIRY]   = {{EVO_LEVEL, 40, SPECIES_CLEFABLE}},
    [SPECIES_VULPIX]     = {{EVO_LEVEL, 35, SPECIES_NINETALES}},
    [SPECIES_JIGGLYPUFF] = {{EVO_LEVEL, 25, SPECIES_WIGGLYTUFF}},
    [SPECIES_ZUBAT]      = {{EVO_LEVEL, 25, SPECIES_GOLBAT}},
    [SPECIES_ODDISH]     = {{EVO_LEVEL, 32, SPECIES_GLOOM},
                            {EVO_ITEM, ITEM_POWER_SHARD, SPECIES_VILEPLUME}},
    ...
    [SPECIES_GROWLITHE]  = {{EVO_ITEM, ITEM_DEFENSE_SHARD, SPECIES_ARCANINE}},
    [SPECIES_POLIWAG]    = {{EVO_LEVEL, 25, SPECIES_POLIWHIRL}},
    [SPECIES_POLIWHIRL]  = {{EVO_ITEM, ITEM_TECH_SHARD, SPECIES_POLIWRATH},
    ...
    [SPECIES_WEEPINBELL] = {{EVO_ITEM, ITEM_HELPER_SHARD, SPECIES_VICTREEBEL}},
    ...
    [SPECIES_STARYU]     = {{EVO_ITEM, ITEM_TECH_SHARD, SPECIES_STARMIE}},
    [SPECIES_SCYTHER]    = {{EVO_TRADE_ITEM, ITEM_MAID_UNIFORM, SPECIES_SCIZOR}},
    [SPECIES_MAGIKARP]   = {{EVO_LEVEL, 20, SPECIES_GYARADOS}},
    [SPECIES_EEVEE]      = {{EVO_ITEM, ITEM_SWIFT_SHARD, SPECIES_JOLTEON},
                            {EVO_ITEM, ITEM_TECH_SHARD, SPECIES_VAPOREON},
                            {EVO_ITEM, ITEM_DEFENSE_SHARD, SPECIES_FLAREON},
                            {EVO_FRIENDSHIP_DAY, 0, SPECIES_ESPEON},
                            {EVO_FRIENDSHIP_NIGHT, 0, SPECIES_UMBREON}},
    [SPECIES_PORYGON]    = {{EVO_TRADE_ITEM, ITEM_CURSED_LUNCH, SPECIES_PORYGON2}},
    ...
    [SPECIES_PICHU]      = {{EVO_FRIENDSHIP, 0, SPECIES_CCIRNO}},
    ...
    [SPECIES_SUNKERN]    = {{EVO_ITEM, ITEM_SOLAR_SHARD, SPECIES_SUNFLORA}},
    ...
    [SPECIES_LOMBRE]     = {{EVO_ITEM, ITEM_TECH_SHARD, SPECIES_LUDICOLO}},
    [SPECIES_SEEDOT]     = {{EVO_LEVEL, 14, SPECIES_NUZLEAF}},
    [SPECIES_NUZLEAF]    = {{EVO_ITEM, ITEM_HELPER_SHARD, SPECIES_SHIFTRY}},
    ...
    [SPECIES_SKITTY]     = {{EVO_ITEM, ITEM_POWER_SHARD, SPECIES_DELCATTY}},
    ...
    [SPECIES_CLAMPERL]   = {{EVO_TRADE_ITEM, ITEM_KUSANAGI, SPECIES_HUNTAIL},
                            {EVO_TRADE_ITEM, ITEM_YATA_MIRROR, SPECIES_GOREBYSS}},
