...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_WIGGLYTUFF, SPECIES_LINOONE, SPECIES_KINGDRA, SPECIES_DELCATTY, SPECIES_CIRNO, SPECIES_TOKIKO, SPECIES_STARMIE, SPECIES_MEDICHAM, SPECIES_SHIFTRY, SPECIES_BEAUTIFLY},
        .id = 4,
...
static const bool8 sValidApprenticeMoves[MOVES_COUNT] =
{
    ...
    [MOVE_HEADBUTT] = TRUE,
    [MOVE_KNIFE_THROW] = FALSE,
    [MOVE_MAGIC_KNIFE] = FALSE,
    [MOVE_SCULPTURE] = TRUE,
    [MOVE_TACKLE] = FALSE,
    [MOVE_BODY_SLAM] = TRUE,
    [MOVE_WRAP] = TRUE,
    ...
    [MOVE_THUNDER] = TRUE,
    [MOVE_ROCK_WRECKER] = FALSE,
    [MOVE_EARTHQUAKE] = TRUE,
    [MOVE_FISSURE] = TRUE,
    [MOVE_DIG] = TRUE,
    [MOVE_TOXIC] = TRUE,
    [MOVE_PSYSHOT] = FALSE,
    [MOVE_MANA_BURST] = TRUE,
    [MOVE_HYPNOSIS] = TRUE,
    ...
    [MOVE_GUARD] = FALSE,
    [MOVE_METRONOME] = TRUE,
    [MOVE_DRAWN_LINE] = TRUE,
    [MOVE_SELF_DESTRUCT] = TRUE,
    [MOVE_MIND_BOMB] = TRUE,
    [MOVE_LICK] = TRUE,
    [MOVE_TOXIC_GAS] = FALSE,
    [MOVE_GUNK_SHOT] = FALSE,
    [MOVE_BONE_CLUB] = FALSE,
    [MOVE_FIRE_BLAST] = TRUE,
    [MOVE_WATERFALL] = TRUE,
    [MOVE_MANA_SHIELD] = TRUE,
    [MOVE_SWIFT] = TRUE,
    ...
    [MOVE_POISON_BOMB] = TRUE,
    [MOVE_MUD_SLAP] = TRUE,
    [MOVE_BLACK_RIPPLE] = TRUE,
    [MOVE_SPIKES] = TRUE,
    ...
    [MOVE_DISCHARGE] = FALSE,
    [MOVE_FURY_CUTTER] = TRUE,
    [MOVE_STEEL_WING] = TRUE,
    [MOVE_CHARMING_LOOK] = TRUE,
    [MOVE_ATTRACT] = TRUE,
    ...
    [MOVE_STEEL_FIST] = TRUE,
    [MOVE_METAL_CLAW] = TRUE,
    [MOVE_VITAL_THROW] = TRUE,
    [MOVE_ENERGY_LIGHT] = TRUE,
    [MOVE_SYNTHESIS] = TRUE,
    [MOVE_LUNATIC] = TRUE,
    ...
    [MOVE_BEAT_UP] = TRUE,
    [MOVE_FAKE_OUT] = TRUE,
    [MOVE_PERFORMANCE] = TRUE,
    [MOVE_NASTY_PLOT] = TRUE,
    [MOVE_MIRROR_SHOT] = TRUE,
    [MOVE_MYSTIC_WATER] = TRUE,
    [MOVE_HEAT_WAVE] = TRUE,
    [MOVE_HAIL] = TRUE,
    [MOVE_TORMENT] = TRUE,
    [MOVE_LUCKY_CHANT] = TRUE,
    [MOVE_WILL_O_WISP] = TRUE,
    [MOVE_MEMENTO] = TRUE,
    [MOVE_FACADE] = TRUE,
    [MOVE_FOCUS_PUNCH] = TRUE,
    [MOVE_SMELLING_SALT] = TRUE,
    [MOVE_DISTURBANCE] = TRUE,
    [MOVE_ROCK_BULLET] = TRUE,
    [MOVE_BATT_CHARGE] = TRUE,
    [MOVE_TAUNT] = TRUE,
    [MOVE_HELPING_HAND] = TRUE,
    [MOVE_TRICK] = TRUE,
    [MOVE_RECOLLECTION] = TRUE,
    [MOVE_WISH] = TRUE,
    [MOVE_ASSIST] = TRUE,
    [MOVE_INGRAIN] = TRUE,
    ...
    [MOVE_IMPRISON] = TRUE,
    [MOVE_REFRESH] = TRUE,
    [MOVE_SHADOW_DANCE] = TRUE,
    [MOVE_SNATCH] = TRUE,
    [MOVE_SECRET_POWER] = TRUE,
    [MOVE_SHADOW_DIVE] = TRUE,
    [MOVE_FORCE_PALM] = FALSE,
    [MOVE_CAMOUFLAGE] = TRUE,
    [MOVE_MANA_CHARGE] = TRUE,
    ...
    [MOVE_SHADOW_HIT] = TRUE,
    [MOVE_ROCK_TOMB] = TRUE,
    [MOVE_SILVER_WIND] = TRUE,
    [MOVE_BINDING_VOICE] = TRUE,
    [MOVE_NATURE_SOUND] = TRUE,
    [MOVE_TICKLE] = TRUE,
    [MOVE_DRACO_METEOR] = TRUE,
    [MOVE_AQUA_SHOWER] = TRUE,
    ...
    [MOVE_BLADE_FLASH] = TRUE,
    [MOVE_ICE_SHARD] = FALSE,
    [MOVE_IRON_DEFENSE] = TRUE,
    [MOVE_BLOCK] = TRUE,
    [MOVE_HOWL] = TRUE,
    [MOVE_HEART_BREAK] = TRUE,
