...
} static const sCursorOptions[] =
{
    ...
    [MENU_FIELD_MOVES + FIELD_MOVE_SHADOW_DIVE] = {gMoveNames[MOVE_SHADOW_DIVE], CursorCb_FieldMove},
    ...
    [MENU_FIELD_MOVES + FIELD_MOVE_NATURE_POWER] = {gMoveNames[MOVE_NATURE_POWER], CursorCb_FieldMove},
};
...
{
    MOVE_CUT, MOVE_FLASH, MOVE_ROCK_SMASH, MOVE_STRENGTH, MOVE_SURF, MOVE_FLY, MOVE_SHADOW_DIVE, MOVE_WATERFALL, MOVE_TELEPORT,
    MOVE_DIG, MOVE_SECRET_POWER, MOVE_MILK_DRINK, MOVE_SOFT_BOILED, MOVE_NATURE_POWER, FIELD_MOVE_TERMINATOR
};
...
} static const sFieldMoveCursorCallbacks[] =
{
    ...
    [FIELD_MOVE_SHADOW_DIVE]         = {SetUpFieldMove_Dive,        PARTY_MSG_CANT_USE_HERE},
...
static const u16 sTMHMMoves[] =
{
    ...
    [ITEM_TM02 - ITEM_TM01] = MOVE_HEART_BREAK,
    ...
    [ITEM_TM07 - ITEM_TM01] = MOVE_RAZOR_WIND,
    [ITEM_TM08 - ITEM_TM01] = MOVE_CURSE,
    [ITEM_TM09 - ITEM_TM01] = MOVE_DECISION,
    [ITEM_TM10 - ITEM_TM01] = MOVE_POISON_JAB,
    ...
    [ITEM_TM15 - ITEM_TM01] = MOVE_SONIC_BOOM,
    [ITEM_TM16 - ITEM_TM01] = MOVE_LIGHT_SCREEN,
    [ITEM_TM17 - ITEM_TM01] = MOVE_DETECT,
    ...
    [ITEM_TM23 - ITEM_TM01] = MOVE_STEEL_FIST,
    ...
    [ITEM_TM29 - ITEM_TM01] = MOVE_MANA_BURST,
    ...
    [ITEM_TM34 - ITEM_TM01] = MOVE_FOCUS_BLAST,
    [ITEM_TM35 - ITEM_TM01] = MOVE_FLAMETHROWER,
    [ITEM_TM36 - ITEM_TM01] = MOVE_POISON_BOMB,
    [ITEM_TM37 - ITEM_TM01] = MOVE_PSYCHO_CUT,
    [ITEM_TM38 - ITEM_TM01] = MOVE_FIRE_BLAST,
    [ITEM_TM39 - ITEM_TM01] = MOVE_ROCK_TOMB,
    [ITEM_TM40 - ITEM_TM01] = MOVE_SWAGGER,
    [ITEM_TM41 - ITEM_TM01] = MOVE_WILL_O_WISP,
    ...
    [ITEM_TM50 - ITEM_TM01] = MOVE_MIND_BOMB,
    ...
    [ITEM_HM08 - ITEM_TM01] = MOVE_SHADOW_DIVE,
};
