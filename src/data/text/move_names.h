const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_DOUBLE_SLAP] = _("Braver"),
    [MOVE_COMET_PUNCH] = _("Comet Punch"),
    [MOVE_MEGA_PUNCH] = _("Drain Punch"),
    ...
    [MOVE_VICE_GRIP] = _("Night Slash"),
    [MOVE_GUILLOTINE] = _("Judgement"),
    ...
    [MOVE_PETAL_DANCE] = _("Battle Chant"),
    [MOVE_STRING_SHOT] = _("Wire Web"),
    [MOVE_DRAGON_RAGE] = _("Dark Pulse"),
    ...
    [MOVE_ROCK_THROW] = _("Rock Wrecker"),
    [MOVE_EARTHQUAKE] = _("Earthquake"),
    [MOVE_FISSURE] = _("Fissure"),
    [MOVE_DIG] = _("Dig"),
    [MOVE_TOXIC] = _("Toxic"),
    [MOVE_CONFUSION] = _("Psyshot"),
    [MOVE_PSYCHIC] = _("Mana Burst"),
    [MOVE_HYPNOSIS] = _("Hypnosis"),
    [MOVE_MEDITATE] = _("Zen Headbutt"),
    ...
    [MOVE_MIND_READER] = _("Heart's Eye"),
    ...
    [MOVE_SLUDGE_BOMB] = _("Poison Bomb"),
    [MOVE_MUD_SLAP] = _("Mud-Slap"),
    [MOVE_OCTAZOOKA] = _("Black Ripple"),
    [MOVE_SPIKES] = _("Spikes"),
    [MOVE_ZAP_CANNON] = _("Focus Blast"),
    ...
    [MOVE_MEGAHORN] = _("Brace Bird"),
    [MOVE_DRAGON_BREATH] = _("Lava Plume"),
    [MOVE_BATON_PASS] = _("Baton Pass"),
    [MOVE_ENCORE] = _("Encore"),
    [MOVE_PURSUIT] = _("Pursuit"),
    [MOVE_RAPID_SPIN] = _("Rapid Spin"),
    [MOVE_SWEET_SCENT] = _("Nature Power"),
    [MOVE_IRON_TAIL] = _("Steel Fist"),
    [MOVE_METAL_CLAW] = _("Metal Claw"),
    [MOVE_VITAL_THROW] = _("Vital Throw"),
    [MOVE_MORNING_SUN] = _("Energy Light"),
    [MOVE_SYNTHESIS] = _("Synthesis"),
    [MOVE_MOONLIGHT] = _("LUNATIC"),
    [MOVE_HIDDEN_POWER] = _("Charge Beam"),
    ...
    [MOVE_FUTURE_SIGHT] = _("Psycho Cut"),
    [MOVE_ROCK_SMASH] = _("Rock Smash"),
    [MOVE_WHIRLPOOL] = _("Whirlpool"),
    [MOVE_BEAT_UP] = _("Beat Up"),
    [MOVE_FAKE_OUT] = _("Fake Out"),
    [MOVE_UPROAR] = _("Performance"),
    [MOVE_STOCKPILE] = _("Nasty Plot"),
    [MOVE_SPIT_UP] = _("Mirror Shot"),
    [MOVE_SWALLOW] = _("Mystic Water"),
    [MOVE_HEAT_WAVE] = _("Heat Wave"),
    [MOVE_HAIL] = _("Hail"),
    [MOVE_TORMENT] = _("Torment"),
    [MOVE_FLATTER] = _("Lucky Chant"),
    ...
    [MOVE_FOLLOW_ME] = _("Disturbance"),
    [MOVE_NATURE_POWER] = _("Rock Bullet"),
    [MOVE_CHARGE] = _("Batt. Charge"),
    [MOVE_TAUNT] = _("Taunt"),
    [MOVE_HELPING_HAND] = _("Helping Hand"),
    [MOVE_TRICK] = _("Trick"),
    [MOVE_ROLE_PLAY] = _("Recollection"),
    [MOVE_WISH] = _("Wish"),
