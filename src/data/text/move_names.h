const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_SEAL_NEEDLE] = _("Seal Needle"),
    ...
    [MOVE_POISON_TEARS] = _("Poison Tears"),
    [MOVE_EMBER] = _("Ember"),
    ...
    [MOVE_ROCK_SLIDE] = _("Rock Throw"),
    [MOVE_EARTHQUAKE] = _("Earthquake"),
    [MOVE_FISSURE] = _("Fissure"),
    [MOVE_DIG] = _("Dig"),
    [MOVE_TOXIC] = _("Toxic"),
    [MOVE_PSYSHOT] = _("Psyshot"),
    [MOVE_MANA_BURST] = _("Mana Burst"),
    ...
    [MOVE_MYSTIC_WATER] = _("Mystic Water"),
    ...
    [MOVE_BATTERY_CHARGE] = _("Batt. Charge"),
    [MOVE_TAUNT] = _("Taunt"),
    ...
    [MOVE_SHADOW_DANCE] = _("Shadow Dance"),
    [MOVE_SNATCH] = _("Snatch"),
    [MOVE_SECRET_POWER] = _("Secret Power"),
    [MOVE_SHADOW_DIVE] = _("Shadow Dive"),
