...
static const u8 sViceGripDescription[] = _(
    "A dark slash with a high\n"
    "critical-hit ratio.");

static const u8 sGuillotineDescription[] = _(
    "A holy judgement.\n"
    "Instantly KOs if it hits.");
...
static const u8 sDrillPeckDescription[] = _(
    "A gale of wind which will\n"
    "always strikes first.");

static const u8 sSubmissionDescription[] = _(
    "A reckless body slam that\n"
    "will always strikes last.");
...
static const u8 sMegahornDescription[] = _(
    "A brutal diving attack that\n"
    "also hurts the user.");

static const u8 sDragonBreathDescription[] = _(
    "Explodes lava to the foe.\n"
    "May inflict burn.");
...
static const u8 sRainDanceDescription[] = _(
    "Summons heavy rain on the\n"
    "field for 5 turns.");

static const u8 sSunnyDayDescription[] = _(
    "Summons strong sunlight on\n"
...
static const u8 sRolePlayDescription[] = _(
    "Sees the foe's heart and\n"
    "uses its form and moves.");
...
static const u8 sSilverWindDescription[] = _(
    "A holy wind blow that\n"
    "may lower Speed.");

static const u8 sMetalSoundDescription[] = _(
    "A screeching attack that\n"
    "may cause flinching.");
...
const u8 *const gMoveDescriptionPointers[MOVES_COUNT - 1] =
{
    ...
    [MOVE_NIGHT_SLASH - 1] = sViceGripDescription,
    [MOVE_JUDGEMENT - 1] = sGuillotineDescription,
    ...
    [MOVE_KNIFE_THROW - 1] = sHornAttackDescription,
    [MOVE_MAGIC_KNIFE - 1] = sFuryAttackDescription,
    [MOVE_SCULPTURE - 1] = sHornDrillDescription,
    [MOVE_TACKLE - 1] = sTackleDescription,
    [MOVE_BODY_SLAM - 1] = sBodySlamDescription,
    [MOVE_WRAP - 1] = sWrapDescription,
    [MOVE_HEAD_SMASH - 1] = sTakeDownDescription,
    ...
    [MOVE_JAMMING - 1] = sSupersonicDescription,
    [MOVE_SONIC_BOOM - 1] = sSonicBoomDescription,
    [MOVE_DISABLE - 1] = sDisableDescription,
    [MOVE_POISON_TEARS - 1] = sAcidDescription,
    ...
    [MOVE_GALE - 1] = sDrillPeckDescription,
    ...
    [MOVE_BATTLE_CHANT - 1] = sPetalDanceDescription,
    [MOVE_WIRE_WEB - 1] = sWireWebDescription,
    [MOVE_DARK_PULSE - 1] = sDragonRageDescription,
    ...
    [MOVE_ROCK_WRECKER - 1] = sRockThrowDescription,
    ...
    [MOVE_PSYSHOT - 1] = sConfusionDescription,
    [MOVE_MANA_BURST - 1] = sPsychicDescription,
    [MOVE_HYPNOSIS - 1] = sHypnosisDescription,
    [MOVE_ZEN_HEADBUTT - 1] = sMeditateDescription,
    ...
    [MOVE_BURN_POWDER - 1] = sSporeDescription,
    [MOVE_FLASH - 1] = sFlashDescription,
    [MOVE_PSYWAVE - 1] = sPsywaveDescription,
    [MOVE_SPLASH - 1] = sSplashDescription,
    [MOVE_DISPERSE - 1] = sAcidArmorDescription,
    [MOVE_AQUA_JET - 1] = sCrabhammerDescription,
    ...
    [MOVE_HEARTS_EYE - 1] = sMindReaderDescription,
    ...
    [MOVE_POISON_BOMB - 1] = sSludgeBombDescription,
    [MOVE_MUD_SLAP - 1] = sMudSlapDescription,
    [MOVE_BLACK_RIPPLE - 1] = sOctazookaDescription,
    [MOVE_SPIKES - 1] = sSpikesDescription,
    [MOVE_FOCUS_BLAST - 1] = sZapCannonDescription,
    ...
    [MOVE_PRANK - 1] = sPresentDescription,
    ...
    [MOVE_BRAVE_BIRD - 1] = sMegahornDescription,
    [MOVE_LAVA_PLUME - 1] = sDragonBreathDescription,
    ...
    [MOVE_NATURE_POWER - 1] = sSweetScentDescription,
    [MOVE_STEEL_FIST - 1] = sIronTailDescription,
    [MOVE_METAL_CLAW - 1] = sMetalClawDescription,
    [MOVE_VITAL_THROW - 1] = sVitalThrowDescription,
    [MOVE_ENERGY_LIGHT - 1] = sMorningSunDescription,
    [MOVE_SYNTHESIS - 1] = sSynthesisDescription,
    [MOVE_LUNATIC - 1] = sMoonlightDescription,
    [MOVE_CHARGE_BEAM - 1] = sHiddenPowerDescription,
    ...
    [MOVE_PSYCHO_CUT - 1] = sFutureSightDescription,
    ...
    [MOVE_PERFORMANCE - 1] = sUproarDescription,
    [MOVE_NASTY_PLOT - 1] = sStockpileDescription,
    [MOVE_MIRROR_SHOT - 1] = sSpitUpDescription,
    [MOVE_MYSTIC_WATER - 1] = sSwallowDescription,
    [MOVE_HEAT_WAVE - 1] = sHeatWaveDescription,
    [MOVE_HAIL - 1] = sHailDescription,
    [MOVE_TORMENT - 1] = sTormentDescription,
    [MOVE_LUCKY_CHANT - 1] = sFlatterDescription,
    ...
    [MOVE_CROSS_POISON - 1] = sPoisonFangDescription,
    ...
    [MOVE_AIR_SLASH - 1] = sAirCutterDescription,
    [MOVE_FLARE_BLITZ - 1] = sOverheatDescription,
    [MOVE_SHADOW_HIT - 1] = sOdorSleuthDescription,
    [MOVE_ROCK_TOMB - 1] = sRockTombDescription,
    [MOVE_SILVER_WIND - 1] = sSilverWindDescription,
    [MOVE_BINDING_VOICE - 1] = sMetalSoundDescription,
    [MOVE_NATURE_SOUND - 1] = sGrassWhistleDescription,
    [MOVE_TICKLE - 1] = sTickleDescription,
    [MOVE_DRACO_METEOR - 1] = sCosmicPowerDescription,
    [MOVE_AQUA_SHOWER - 1] = sWaterSpoutDescription,
    ...
    [MOVE_SOAR - 1] = sSkyUppercutDescription,
    ...
    [MOVE_BLADE_FLASH - 1] = sAerialAceDescription,
    [MOVE_ICE_SHARD - 1] = sIcicleSpearDescription,
    [MOVE_IRON_DEFENSE - 1] = sIronDefenseDescription,
    [MOVE_BLOCK - 1] = sBlockDescription,
    [MOVE_HOWL - 1] = sHowlDescription,
    [MOVE_HEART_BREAK - 1] = sDragonClawDescription,
