...
const u16 gEasyChatWordsByLetter_M[] = {
    ...
    EC_WORD_MEGA,
    EC_MOVE2(MEGA_DRAIN),
    EC_MOVE2(GIGA_IMPACT),
    EC_MOVE2(DRAIN_PUNCH),
    EC_MOVE2(BRAVE_BIRD),
...
const u16 gEasyChatWordsByLetter_P[] = {
    ...
    EC_WORD_POINTS,
    EC_WORD_POISON,
    EC_MOVE2(CROSS_POISON),
    EC_MOVE2(OMINOUS_WIND),
...
const u16 gEasyChatWordsByLetter_R[] = {
    ...
    EC_MOVE(ROCK_SLIDE),
    EC_MOVE(ROCK_SMASH),
    EC_MOVE(ROCK_WRECKER),
    EC_MOVE(ROCK_TOMB),
    EC_WORD_ROCK_SOLID,
    EC_MOVE2(RECOLLECTION),
