...
static const struct TrainerMonNoItemCustomMoves sParty_GabbyAndTy6[] = {
    ...
    .moves = {MOVE_ASTONISH, MOVE_STOMP, MOVE_JAMMING, MOVE_HYPER_VOICE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Braxton[] = {
    ...
    .lvl = 28,
    .species = SPECIES_MAGNETON,
    .moves = {MOVE_THUNDERBOLT, MOVE_JAMMING, MOVE_THUNDER_WAVE, MOVE_SONIC_BOOM}
    },
    {
    .iv = 100,
    .lvl = 28,
...
static const struct TrainerMonItemCustomMoves sParty_Daphne[] = {
    ...
    .species = SPECIES_LUVDISC,
    .heldItem = ITEM_NUGGET,
    .moves = {MOVE_ATTRACT, MOVE_SAFEGUARD, MOVE_HEAD_SMASH, MOVE_WATER_PULSE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Cindy6[] = {
    ...
    .species = SPECIES_LINOONE,
    .heldItem = ITEM_NUGGET,
    .moves = {MOVE_FURY_SWIPES, MOVE_EARTH_POWER, MOVE_SHADOW_HIT, MOVE_SAND_ATTACK}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Jessica1[] = {
    ...
    .lvl = 29,
    .species = SPECIES_SEVIPER,
    .moves = {MOVE_POISON_JAB, MOVE_SCREECH, MOVE_COERCE, MOVE_CRUNCH}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Kirk[] = {
    ...
    .moves = {MOVE_BATT_CHARGE, MOVE_SHOCK_WAVE, MOVE_SCREECH, MOVE_NONE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Walter3[] = {
    ...
    .lvl = 36,
    .species = SPECIES_LINOONE,
    .moves = {MOVE_HEADBUTT, MOVE_SAND_ATTACK, MOVE_SHADOW_HIT, MOVE_FURY_SWIPES}
    },
    {
    .iv = 20,
    .lvl = 36,
    .species = SPECIES_MANECTRIC,
    .moves = {MOVE_QUICK_ATTACK, MOVE_DISCHARGE, MOVE_SHADOW_HIT, MOVE_ROAR}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Walter4[] = {
    ...
    .lvl = 39,
    .species = SPECIES_MANECTRIC,
    .moves = {MOVE_QUICK_ATTACK, MOVE_DISCHARGE, MOVE_SHADOW_HIT, MOVE_NONE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Sidney[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_BLADE_FLASH, MOVE_ROCK_SLIDE, MOVE_SWORDS_DANCE, MOVE_SLASH}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Phoebe[] = {
    ...
    .species = SPECIES_BANETTE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_BALL, MOVE_SHADOW_DANCE, MOVE_WILL_O_WISP, MOVE_FAINT_ATTACK}
    },
    {
    .iv = 250,
    .lvl = 50,
    ...
    .species = SPECIES_BANETTE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_BALL, MOVE_MANA_BURST, MOVE_THUNDERBOLT, MOVE_FACADE}
    },
    {
    .iv = 255,
    .lvl = 51,
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    .species = SPECIES_GEODUDE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TACKLE, MOVE_DEFENSE_CURL, MOVE_ROCK_WRECKER, MOVE_ROCK_TOMB}
    },
    {
    .iv = 100,
    .lvl = 12,
...
static const struct TrainerMonItemCustomMoves sParty_Wattson1[] = {
    ...
    .species = SPECIES_MAGNETON,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_JAMMING, MOVE_SHOCK_WAVE, MOVE_THUNDER_WAVE, MOVE_SONIC_BOOM}
    },
    {
    .iv = 250,
    .lvl = 24,
...
static const struct TrainerMonItemCustomMoves sParty_Flannery1[] = {
    ...
    .species = SPECIES_NUMEL,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FLARE_BLITZ, MOVE_HEAD_SMASH, MOVE_MAGNITUDE, MOVE_SUNNY_DAY}
    },
    {
    .iv = 200,
    .lvl = 24,
    ...
    .species = SPECIES_CAMERUPT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FLARE_BLITZ, MOVE_TACKLE, MOVE_SUNNY_DAY, MOVE_ATTRACT}
    },
    {
    .iv = 250,
    .lvl = 29,
    ...
    .moves = {MOVE_FLARE_BLITZ, MOVE_SUNNY_DAY, MOVE_BODY_SLAM, MOVE_ATTRACT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Winona1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PERISH_SONG, MOVE_DRAWN_LINE, MOVE_SAFEGUARD, MOVE_BLADE_FLASH}
    },
    {
    .iv = 210,
    .lvl = 29,
    .species = SPECIES_TROPIUS,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SUNNY_DAY, MOVE_BLADE_FLASH, MOVE_SOLAR_BEAM, MOVE_SYNTHESIS}
    },
    {
    .iv = 210,
    .lvl = 30,
    .species = SPECIES_PELIPPER,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WATER_GUN, MOVE_JAMMING, MOVE_PROTECT, MOVE_BLADE_FLASH}
    },
    {
    .iv = 220,
    .lvl = 31,
    .species = SPECIES_SKARMORY,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SAND_ATTACK, MOVE_MAGIC_KNIFE, MOVE_STEEL_WING, MOVE_BLADE_FLASH}
    },
    {
    .iv = 255,
    .lvl = 33,
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza1[] = {
    ...
    .species = SPECIES_CLAYDOL,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EARTHQUAKE, MOVE_ANCIENT_POWER, MOVE_MANA_BURST, MOVE_LIGHT_SCREEN}
    },
    {
    .iv = 250,
    .lvl = 41,
    .species = SPECIES_XATU,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_MANA_BURST, MOVE_SUNNY_DAY, MOVE_CONFUSE_RAY, MOVE_CALM_MIND}
    },
    {
    .iv = 250,
    .lvl = 42,
    .species = SPECIES_LUNATONE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_LIGHT_SCREEN, MOVE_MANA_BURST, MOVE_HYPNOSIS, MOVE_CALM_MIND}
    },
    {
    .iv = 250,
    .lvl = 42,
    .species = SPECIES_SOLROCK,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SUNNY_DAY, MOVE_SOLAR_BEAM, MOVE_MANA_BURST, MOVE_FLAMETHROWER}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_AnnaAndMeg1[] = {
    ...
    .lvl = 15,
    .species = SPECIES_ZIGZAGOON,
    .moves = {MOVE_GROWL, MOVE_TAIL_WHIP, MOVE_HEADBUTT, MOVE_SHADOW_HIT}
    },
    {
    .iv = 0,
    .lvl = 17,
...
static const struct TrainerMonNoItemCustomMoves sParty_Ben[] = {
    ...
    .moves = {MOVE_AMNESIA, MOVE_GUNK_SHOT, MOVE_YAWN, MOVE_POUND}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Katelynn[] = {
    ...
    .moves = {MOVE_SKILL_SWAP, MOVE_MANA_BURST, MOVE_THUNDERBOLT, MOVE_CALM_MIND}
    },
    {
    .iv = 100,
    .lvl = 43,
...
static const struct TrainerMonItemCustomMoves sParty_Wallace[] = {
    ...
    .species = SPECIES_TENTACRUEL,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TOXIC, MOVE_HYDRO_PUMP, MOVE_POISON_BOMB, MOVE_ICE_BEAM}
    },
    {
    .iv = 255,
    .lvl = 56,
...
static const struct TrainerMonNoItemCustomMoves sParty_Lao1[] = {
    ...
    .lvl = 17,
    .species = SPECIES_KOFFING,
    .moves = {MOVE_OMINOUS_WIND, MOVE_TACKLE, MOVE_GUNK_SHOT, MOVE_SELF_DESTRUCT}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Lao2[] = {
    ...
    .lvl = 24,
    .species = SPECIES_KOFFING,
    .moves = {MOVE_OMINOUS_WIND, MOVE_TACKLE, MOVE_GUNK_SHOT, MOVE_NONE}
    },
    {
    .iv = 0,
    .lvl = 24,
    ...
    .lvl = 26,
    .species = SPECIES_KOFFING,
    .moves = {MOVE_TACKLE, MOVE_GUNK_SHOT, MOVE_NONE, MOVE_NONE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Madeline3[] = {
    ...
    .lvl = 32,
    .species = SPECIES_NUMEL,
    .moves = {MOVE_EMBER, MOVE_HEAD_SMASH, MOVE_MAGNITUDE, MOVE_SUNNY_DAY}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Madeline4[] = {
    ...
    .lvl = 34,
    .species = SPECIES_NUMEL,
    .moves = {MOVE_FLAMETHROWER, MOVE_HEAD_SMASH, MOVE_MAGNITUDE, MOVE_SUNNY_DAY}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Madeline5[] = {
    ...
    .lvl = 37,
    .species = SPECIES_CAMERUPT,
    .moves = {MOVE_FLAMETHROWER, MOVE_HEAD_SMASH, MOVE_EARTHQUAKE, MOVE_SUNNY_DAY}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_AmyAndLiv5[] = {
    ...
    .lvl = 33,
    .species = SPECIES_PLUSLE,
    .moves = {MOVE_DISCHARGE, MOVE_BATT_CHARGE, MOVE_FAKE_TEARS, MOVE_HELPING_HAND}
    },
    {
    .iv = 30,
    .lvl = 33,
    .species = SPECIES_MINUN,
    .moves = {MOVE_DISCHARGE, MOVE_BATT_CHARGE, MOVE_CHARM, MOVE_HELPING_HAND}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_AmyAndLiv6[] = {
    ...
    .lvl = 36,
    .species = SPECIES_PLUSLE,
    .moves = {MOVE_THUNDER, MOVE_BATT_CHARGE, MOVE_FAKE_TEARS, MOVE_HELPING_HAND}
    },
    {
    .iv = 40,
    .lvl = 36,
    .species = SPECIES_MINUN,
    .moves = {MOVE_THUNDER, MOVE_BATT_CHARGE, MOVE_CHARM, MOVE_HELPING_HAND}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Jonas[] = {
    ...
    .lvl = 31,
    .species = SPECIES_KOFFING,
    .moves = {MOVE_TOXIC, MOVE_THUNDER, MOVE_SELF_DESTRUCT, MOVE_POISON_BOMB}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_WallyVR1[] = {
    ...
    .lvl = 41,
    .species = SPECIES_MAGNETON,
    .moves = {MOVE_JAMMING, MOVE_THUNDERBOLT, MOVE_TRI_ATTACK, MOVE_SCREECH}
    },
    {
    .iv = 250,
    .lvl = 45,
    .species = SPECIES_GARDEVOIR,
    .moves = {MOVE_DOUBLE_TEAM, MOVE_CALM_MIND, MOVE_MANA_BURST, MOVE_PSYCHO_CUT}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Mitchell[] = {
    ...
    .lvl = 43,
    .species = SPECIES_LUNATONE,
    .moves = {MOVE_EXPLOSION, MOVE_REFLECT, MOVE_LIGHT_SCREEN, MOVE_MANA_BURST}
    },
    {
    .iv = 0,
    .lvl = 43,
...
static const struct TrainerMonNoItemCustomMoves sParty_Hideo[] = {
    ...
    .lvl = 25,
    .species = SPECIES_KOFFING,
    .moves = {MOVE_TACKLE, MOVE_SELF_DESTRUCT, MOVE_GUNK_SHOT, MOVE_SMOKESCREEN}
    },
    {
    .iv = 0,
    .lvl = 25,
    .species = SPECIES_KOFFING,
    .moves = {MOVE_TACKLE, MOVE_OMINOUS_WIND, MOVE_GUNK_SHOT, MOVE_SMOKESCREEN}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Keigo[] = {
    ...
    .lvl = 28,
    .species = SPECIES_KOFFING,
    .moves = {MOVE_OMINOUS_WIND, MOVE_SELF_DESTRUCT, MOVE_GUNK_SHOT, MOVE_SMOKESCREEN}
    },
    {
    .iv = 0,
    .lvl = 28,
...
static const struct TrainerMonNoItemCustomMoves sParty_KimAndIris[] = {
    ...
    .lvl = 32,
    .species = SPECIES_SWABLU,
    .moves = {MOVE_SING, MOVE_MAGIC_KNIFE, MOVE_SAFEGUARD, MOVE_BLADE_FLASH}
    },
    {
    .iv = 0,
    .lvl = 35,
    .species = SPECIES_NUMEL,
    .moves = {MOVE_FLAMETHROWER, MOVE_HEAD_SMASH, MOVE_REST, MOVE_EARTHQUAKE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_TyraAndIvy[] = {
    ...
    .lvl = 20,
    .species = SPECIES_GRAVELER,
    .moves = {MOVE_DEFENSE_CURL, MOVE_TREMORS, MOVE_EARTH_POWER, MOVE_ROCK_WRECKER}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne2[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_STEEL_FIST, MOVE_EXPLOSION, MOVE_ROAR, MOVE_ROCK_SLIDE}
    },
    {
    .iv = 255,
    .lvl = 37,
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne5[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROCK_SLIDE, MOVE_HYPER_BEAM, MOVE_JAMMING, MOVE_PROTECT}
    },
    {
    .iv = 255,
    .lvl = 47,
...
static const struct TrainerMonItemCustomMoves sParty_Brawly4[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SOAR, MOVE_PROTECT, MOVE_FIRE_PUNCH, MOVE_ICE_PUNCH}
    },
    {
    .iv = 255,
    .lvl = 43,
...
static const struct TrainerMonItemCustomMoves sParty_Brawly5[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_GIGA_IMPACT, MOVE_FOCUS_PUNCH, MOVE_EARTHQUAKE, MOVE_BULK_UP}
    },
    {
    .iv = 255,
    .lvl = 46,
...
static const struct TrainerMonItemCustomMoves sParty_Wattson2[] = {
    ...
    .species = SPECIES_MAGNETON,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_JAMMING, MOVE_PROTECT, MOVE_THUNDER, MOVE_RAIN_DANCE}
    },
    {
    .iv = 255,
    .lvl = 40,
...
static const struct TrainerMonItemCustomMoves sParty_Flannery2[] = {
    ...
    .species = SPECIES_MAGCARGO,
    .heldItem = ITEM_WHITE_HERB,
    .moves = {MOVE_FLARE_BLITZ, MOVE_ATTRACT, MOVE_LIGHT_SCREEN, MOVE_ROCK_SLIDE}
    },
    {
    .iv = 255,
    .lvl = 36,
    ...
    .species = SPECIES_CAMERUPT,
    .heldItem = ITEM_WHITE_HERB,
    .moves = {MOVE_FLARE_BLITZ, MOVE_SUNNY_DAY, MOVE_EARTHQUAKE, MOVE_ATTRACT}
    },
    {
    .iv = 255,
    .lvl = 40,
    .species = SPECIES_TORKOAL,
    .heldItem = ITEM_WHITE_HERB,
    .moves = {MOVE_FLARE_BLITZ, MOVE_SUNNY_DAY, MOVE_EXPLOSION, MOVE_ATTRACT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Norman5[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HEAD_SMASH, MOVE_PROTECT, MOVE_FIRE_BLAST, MOVE_EARTHQUAKE}
    },
    {
    .iv = 255,
    .lvl = 58,
...
static const struct TrainerMonItemCustomMoves sParty_Winona2[] = {
    ...
    .species = SPECIES_TROPIUS,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SUNNY_DAY, MOVE_BLADE_FLASH, MOVE_SOLAR_BEAM, MOVE_EARTHQUAKE}
    },
    {
    .iv = 255,
    .lvl = 41,
    .species = SPECIES_PELIPPER,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SURF, MOVE_JAMMING, MOVE_PROTECT, MOVE_BLADE_FLASH}
    },
    {
    .iv = 255,
    .lvl = 43,
    .species = SPECIES_SKARMORY,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WHIRLWIND, MOVE_SPIKES, MOVE_STEEL_WING, MOVE_BLADE_FLASH}
    },
    {
    .iv = 255,
    .lvl = 45,
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza2[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_YAWN, MOVE_MANA_BURST, MOVE_CALM_MIND, MOVE_PROTECT}
    },
    {
    .iv = 255,
    .lvl = 49,
    ...
    .species = SPECIES_XATU,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_MANA_BURST, MOVE_REST, MOVE_CONFUSE_RAY, MOVE_CALM_MIND}
    },
    {
    .iv = 255,
    .lvl = 50,
    .species = SPECIES_LUNATONE,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_EARTHQUAKE, MOVE_MANA_BURST, MOVE_REST, MOVE_CALM_MIND}
    },
    {
    .iv = 255,
    .lvl = 50,
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza3[] = {
    ...
    .species = SPECIES_CLAYDOL,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EARTHQUAKE, MOVE_EXPLOSION, MOVE_MANA_BURST, MOVE_LIGHT_SCREEN}
    },
    {
    .iv = 255,
    .lvl = 54,
...
static const struct TrainerMonItemCustomMoves sParty_Juan3[] = {
    ...
    .species = SPECIES_CRAWDAUNT,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_REST, MOVE_JUDGEMENT, MOVE_TAUNT, MOVE_DOUBLE_TEAM}
    },
    {
    .iv = 255,
    .lvl = 56,
...
static const struct TrainerMonItemCustomMoves sParty_Steven[] = {
    ...
    .species = SPECIES_SKARMORY,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TOXIC, MOVE_BLADE_FLASH, MOVE_SPIKES, MOVE_STEEL_WING}
    },
    {
    .iv = 255,
    .lvl = 75,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WATER_PULSE, MOVE_ANCIENT_POWER, MOVE_BLADE_FLASH, MOVE_SLASH}
    },
    {
    .iv = 255,
    .lvl = 78,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_EARTHQUAKE, MOVE_MANA_BURST, MOVE_METEOR_MASH, MOVE_SHADOW_BALL}
    }
};
