...
static const struct TrainerMonItemCustomMoves sParty_Randall[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_QUICK_ATTACK, MOVE_AGILITY, MOVE_GALE, MOVE_NONE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Braxton[] = {
    ...
    .lvl = 28,
    .species = SPECIES_SWELLOW,
    .moves = {MOVE_FOCUS_ENERGY, MOVE_QUICK_ATTACK, MOVE_GALE, MOVE_ENDEAVOR}
    },
    {
    .iv = 100,
    .lvl = 28,
    ...
    .lvl = 28,
    .species = SPECIES_SHIFTRY,
    .moves = {MOVE_GIGA_DRAIN, MOVE_FEINT_ATTACK, MOVE_SHADOW_HIT, MOVE_SWAGGER}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Walter3[] = {
    ...
    .lvl = 36,
    .species = SPECIES_LINOONE,
    .moves = {MOVE_HEADBUTT, MOVE_SAND_ATTACK, MOVE_DOUBLE_TEAM, MOVE_FURY_SWIPES}
    },
    {
    .iv = 20,
    .lvl = 36,
...
static const struct TrainerMonItemCustomMoves sParty_Sidney[] = {
    ...
    .species = SPECIES_SHIFTRY,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TORMENT, MOVE_SHADOW_HIT, MOVE_SWAGGER, MOVE_EXTRASENSORY}
    },
    {
    .iv = 250,
    .lvl = 46,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_BLADE_FLASH, MOVE_ROCK_WRECKER, MOVE_SWORDS_DANCE, MOVE_SLASH}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Phoebe[] = {
    ...
    .species = SPECIES_BANETTE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_BALL, MOVE_SHADOW_DANCE, MOVE_WILL_O_WISP, MOVE_FEINT_ATTACK}
    },
    {
    .iv = 250,
    .lvl = 50,
    .species = SPECIES_SABLEYE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_BALL, MOVE_SHADOW_HIT, MOVE_NIGHT_SHADE, MOVE_FEINT_ATTACK}
    },
    {
    .iv = 250,
    .lvl = 49,
    ...
    .species = SPECIES_DUSCLOPS,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SHADOW_BALL, MOVE_ICE_BEAM, MOVE_ROCK_WRECKER, MOVE_EARTHQUAKE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Drake[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_FLAMETHROWER, MOVE_HEART_BREAK, MOVE_ROCK_WRECKER, MOVE_CRUNCH}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Flannery1[] = {
    ...
    .species = SPECIES_SLUGMA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_OVERHEAT, MOVE_TOXIC_GAS, MOVE_LIGHT_SCREEN, MOVE_SUNNY_DAY}
    },
    {
    .iv = 250,
    .lvl = 26,
...
static const struct TrainerMonItemCustomMoves sParty_Juan1[] = {
    ...
    .moves = {MOVE_WATER_PULSE, MOVE_SHADOW_HIT, MOVE_ICE_BEAM, MOVE_REST}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_AnnaAndMeg1[] = {
    ...
    .lvl = 15,
    .species = SPECIES_ZIGZAGOON,
    .moves = {MOVE_GROWL, MOVE_TAIL_WHIP, MOVE_HEADBUTT, MOVE_DOUBLE_TEAM}
    },
    {
    .iv = 0,
    .lvl = 17,
...
static const struct TrainerMonItemCustomMoves sParty_Colton[] = {
    ...
    .species = SPECIES_SKITTY,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_ASSIST, MOVE_SMILE, MOVE_FEINT_ATTACK, MOVE_HEAL_BELL}
    },
    {
    .iv = 0,
    .lvl = 36,
...
static const struct TrainerMonItemCustomMoves sParty_Wallace[] = {
    ...
    .species = SPECIES_LUDICOLO,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_GIGA_DRAIN, MOVE_SURF, MOVE_LEECH_SEED, MOVE_SHADOW_HIT}
    },
    {
    .iv = 255,
    .lvl = 56,
...
static const struct TrainerMonNoItemCustomMoves sParty_AmyAndLiv5[] = {
    ...
    .lvl = 33,
    .species = SPECIES_PLUSLE,
    .moves = {MOVE_DISCHARGE, MOVE_BATTERY_CHARGE, MOVE_FAKE_TEARS, MOVE_HELPING_HAND}
    },
    {
    .iv = 30,
    .lvl = 33,
    .species = SPECIES_MINUN,
    .moves = {MOVE_DISCHARGE, MOVE_BATTERY_CHARGE, MOVE_SMILE, MOVE_HELPING_HAND}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_AmyAndLiv6[] = {
    ...
    .lvl = 36,
    .species = SPECIES_MINUN,
    .moves = {MOVE_THUNDER, MOVE_BATTERY_CHARGE, MOVE_SMILE, MOVE_HELPING_HAND}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_WallyVR1[] = {
    ...
    .lvl = 43,
    .species = SPECIES_DELCATTY,
    .moves = {MOVE_SING, MOVE_ASSIST, MOVE_SMILE, MOVE_FEINT_ATTACK}
    },
    {
    .iv = 150,
    .lvl = 44,
    ...
    .lvl = 45,
    .species = SPECIES_GARDEVOIR,
    .moves = {MOVE_SHADOW_HIT, MOVE_CALM_MIND, MOVE_MANA_BURST, MOVE_PSYCHO_CUT}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Keigo[] = {
    ...
    .lvl = 28,
    .species = SPECIES_NINJASK,
    .moves = {MOVE_SAND_ATTACK, MOVE_SHADOW_HIT, MOVE_FURY_CUTTER, MOVE_SWORDS_DANCE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne2[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SWORDS_DANCE, MOVE_ICE_BEAM, MOVE_SURF, MOVE_ROCK_WRECKER}
    },
    {
    .iv = 255,
    .lvl = 35,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_STEEL_FIST, MOVE_EXPLOSION, MOVE_ROAR, MOVE_ROCK_WRECKER}
    },
    {
    .iv = 255,
    .lvl = 37,
    .species = SPECIES_NOSEPASS,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SHADOW_HIT, MOVE_EXPLOSION, MOVE_PROTECT, MOVE_ROCK_WRECKER}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne3[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PROTECT, MOVE_ICE_BEAM, MOVE_ROCK_WRECKER, MOVE_SURF}
    },
    {
    .iv = 255,
    .lvl = 37,
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne5[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROCK_WRECKER, MOVE_HYPER_BEAM, MOVE_JAMMING, MOVE_PROTECT}
    },
    {
    .iv = 255,
    .lvl = 47,
...
static const struct TrainerMonItemCustomMoves sParty_Brawly2[] = {
    ...
    .species = SPECIES_MACHAMP,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_KARATE_CHOP, MOVE_ROCK_WRECKER, MOVE_FOCUS_PUNCH, MOVE_BULK_UP}
    },
    {
    .iv = 255,
    .lvl = 33,
...
static const struct TrainerMonItemCustomMoves sParty_Brawly5[] = {
    ...
    .species = SPECIES_MACHAMP,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_CROSS_CHOP, MOVE_ROCK_WRECKER, MOVE_FOCUS_PUNCH, MOVE_BULK_UP}
    },
    {
    .iv = 255,
    .lvl = 48,
...
static const struct TrainerMonItemCustomMoves sParty_Flannery2[] = {
    ...
    .species = SPECIES_MAGCARGO,
    .heldItem = ITEM_WHITE_HERB,
    .moves = {MOVE_OVERHEAT, MOVE_ATTRACT, MOVE_LIGHT_SCREEN, MOVE_ROCK_WRECKER}
    },
    {
    .iv = 255,
    .lvl = 36,
...
static const struct TrainerMonItemCustomMoves sParty_Juan2[] = {
    ...
    .species = SPECIES_WHISCASH,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_RAIN_DANCE, MOVE_WATER_PULSE, MOVE_SHADOW_HIT, MOVE_FISSURE}
    },
    {
    .iv = 255,
    .lvl = 48,
    ...
    .species = SPECIES_CRAWDAUNT,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_REST, MOVE_AQUA_JET, MOVE_TAUNT, MOVE_SHADOW_HIT}
    },
    {
    .iv = 255,
    .lvl = 51,
...
static const struct TrainerMonItemCustomMoves sParty_Juan3[] = {
    ...
    .species = SPECIES_CRAWDAUNT,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_REST, MOVE_JUDGEMENT, MOVE_TAUNT, MOVE_SHADOW_HIT}
    },
    {
    .iv = 255,
    .lvl = 56,
...
static const struct TrainerMonItemCustomMoves sParty_Angelo[] = {
    ...
    .species = SPECIES_ILLUMISE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHOCK_WAVE, MOVE_QUICK_ATTACK, MOVE_SMILE, MOVE_NONE}
    },
    {
    .iv = 100,
    .lvl = 17,
