const u8 *const gMonFootprintTable[] =
{
    ...
    [SPECIES_CLILYWHITE] = gMonFootprint_Squirtle,
    [SPECIES_LILYWHITE] = gMonFootprint_Wartortle,
    [SPECIES_CLILYBLACK] = gMonFootprint_Blastoise,
    [SPECIES_LILYBLACK] = gMonFootprint_Caterpie,
    [SPECIES_CMOMIJI] = gMonFootprint_Metapod,
    [SPECIES_MOMIJI] = gMonFootprint_Butterfree,
    [SPECIES_CSHIZUHA] = gMonFootprint_Weedle,
    [SPECIES_SHIZUHA] = gMonFootprint_Kakuna,
    [SPECIES_CMEDICINE] = gMonFootprint_Beedrill,
    [SPECIES_MEDICINE] = gMonFootprint_Pidgey,
    [SPECIES_CKOAKUMA] = gMonFootprint_Pidgeotto,
    [SPECIES_KOAKUMA] = gMonFootprint_Pidgeot,
    [SPECIES_CNAZRIN] = gMonFootprint_Rattata,
    [SPECIES_NAZRIN] = gMonFootprint_Raticate,
    [SPECIES_CTOKIKO] = gMonFootprint_Spearow,
    [SPECIES_TOKIKO] = gMonFootprint_Fearow,
    [SPECIES_CREMILIA] = gMonFootprint_Ekans,
    [SPECIES_REMILIA] = gMonFootprint_Arbok,
    [SPECIES_CCIRNO] = gMonFootprint_Pikachu,
    [SPECIES_CIRNO] = gMonFootprint_Raichu,
    ...
    [SPECIES_CYOUMU] = gMonFootprint_Nidorino,
    [SPECIES_YOUMU] = gMonFootprint_Nidoking,
