const struct CompressedSpriteSheet gMonAnimFrontPicTable[] =
{
    SPECIES_SPRITE(NONE, gMonFrontPic_CircledQuestionMark),
    SPECIES_SPRITE(CSANAE, gMonFrontPic_Bulbasaur),
    SPECIES_SPRITE(SANAE, gMonFrontPic_Ivysaur),
    SPECIES_SPRITE(CALICE, gMonFrontPic_Venusaur),
    SPECIES_SPRITE(ALICE, gMonFrontPic_Charmander),
    SPECIES_SPRITE(CREISEN, gMonFrontPic_Charmeleon),
    SPECIES_SPRITE(REISEN, gMonFrontPic_Charizard),
    SPECIES_SPRITE(CLILYWHITE, gMonFrontPic_Squirtle),
    SPECIES_SPRITE(LILYWHITE, gMonFrontPic_Wartortle),
    SPECIES_SPRITE(CLILYBLACK, gMonFrontPic_Blastoise),
    SPECIES_SPRITE(LILYBLACK, gMonFrontPic_Caterpie),
    SPECIES_SPRITE(CMOMIJI, gMonFrontPic_Metapod),
    SPECIES_SPRITE(MOMIJI, gMonFrontPic_Butterfree),
    SPECIES_SPRITE(CSHIZUHA, gMonFrontPic_Weedle),
    SPECIES_SPRITE(SHIZUHA, gMonFrontPic_Kakuna),
    SPECIES_SPRITE(CMEDICINE, gMonFrontPic_Beedrill),
    SPECIES_SPRITE(MEDICINE, gMonFrontPic_Pidgey),
    SPECIES_SPRITE(CKOAKUMA, gMonFrontPic_Pidgeotto),
    SPECIES_SPRITE(KOAKUMA, gMonFrontPic_Pidgeot),
    SPECIES_SPRITE(CNAZRIN, gMonFrontPic_Rattata),
    SPECIES_SPRITE(NAZRIN, gMonFrontPic_Raticate),
    SPECIES_SPRITE(CTOKIKO, gMonFrontPic_Spearow),
    SPECIES_SPRITE(TOKIKO, gMonFrontPic_Fearow),
    SPECIES_SPRITE(CREMILIA, gMonFrontPic_Ekans),
    SPECIES_SPRITE(REMILIA, gMonFrontPic_Arbok),
    SPECIES_SPRITE(CCIRNO, gMonFrontPic_Pikachu),
    SPECIES_SPRITE(CIRNO, gMonFrontPic_Raichu),
    ...
    SPECIES_SPRITE(CYOUMU, gMonFrontPic_Nidorino),
    SPECIES_SPRITE(YOUMU, gMonFrontPic_Nidoking),
