const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(CLILYWHITE, gMonShinyPalette_Squirtle),
    SPECIES_SHINY_PAL(LILYWHITE, gMonShinyPalette_Wartortle),
    SPECIES_SHINY_PAL(CLILYBLACK, gMonShinyPalette_Blastoise),
    SPECIES_SHINY_PAL(LILYBLACK, gMonShinyPalette_Caterpie),
    SPECIES_SHINY_PAL(CMOMIJI, gMonShinyPalette_Metapod),
    SPECIES_SHINY_PAL(MOMIJI, gMonShinyPalette_Butterfree),
    SPECIES_SHINY_PAL(CSHIZUHA, gMonShinyPalette_Weedle),
    SPECIES_SHINY_PAL(SHIZUHA, gMonShinyPalette_Kakuna),
    SPECIES_SHINY_PAL(CMEDICINE, gMonShinyPalette_Beedrill),
    SPECIES_SHINY_PAL(MEDICINE, gMonShinyPalette_Pidgey),
    SPECIES_SHINY_PAL(CKOAKUMA, gMonShinyPalette_Pidgeotto),
    SPECIES_SHINY_PAL(KOAKUMA, gMonShinyPalette_Pidgeot),
    SPECIES_SHINY_PAL(CNAZRIN, gMonShinyPalette_Rattata),
    SPECIES_SHINY_PAL(NAZRIN, gMonShinyPalette_Raticate),
    SPECIES_SHINY_PAL(CTOKIKO, gMonShinyPalette_Spearow),
    SPECIES_SHINY_PAL(TOKIKO, gMonShinyPalette_Fearow),
    SPECIES_SHINY_PAL(CREMILIA, gMonShinyPalette_Ekans),
    SPECIES_SHINY_PAL(REMILIA, gMonShinyPalette_Arbok),
    SPECIES_SHINY_PAL(CCIRNO, gMonShinyPalette_Pikachu),
    SPECIES_SHINY_PAL(CIRNO, gMonShinyPalette_Raichu),
    ...
    SPECIES_SHINY_PAL(CYOUMU, gMonShinyPalette_Nidorino),
    SPECIES_SHINY_PAL(YOUMU, gMonShinyPalette_Nidoking),
