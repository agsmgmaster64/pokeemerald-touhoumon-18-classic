const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(CLILYWHITE, gMonPalette_Squirtle),
    SPECIES_PAL(LILYWHITE, gMonPalette_Wartortle),
    SPECIES_PAL(CLILYBLACK, gMonPalette_Blastoise),
    SPECIES_PAL(LILYBLACK, gMonPalette_Caterpie),
    SPECIES_PAL(CMOMIJI, gMonPalette_Metapod),
    SPECIES_PAL(MOMIJI, gMonPalette_Butterfree),
    SPECIES_PAL(CSHIZUHA, gMonPalette_Weedle),
    SPECIES_PAL(SHIZUHA, gMonPalette_Kakuna),
    SPECIES_PAL(CMEDICINE, gMonPalette_Beedrill),
    SPECIES_PAL(MEDICINE, gMonPalette_Pidgey),
    SPECIES_PAL(CKOAKUMA, gMonPalette_Pidgeotto),
    SPECIES_PAL(KOAKUMA, gMonPalette_Pidgeot),
    SPECIES_PAL(CNAZRIN, gMonPalette_Rattata),
    SPECIES_PAL(NAZRIN, gMonPalette_Raticate),
    SPECIES_PAL(CTOKIKO, gMonPalette_Spearow),
    SPECIES_PAL(TOKIKO, gMonPalette_Fearow),
    SPECIES_PAL(CREMILIA, gMonPalette_Ekans),
    SPECIES_PAL(REMILIA, gMonPalette_Arbok),
    SPECIES_PAL(CCIRNO, gMonPalette_Pikachu),
    SPECIES_PAL(CIRNO, gMonPalette_Raichu),
    ...
    SPECIES_PAL(CYOUMU, gMonPalette_Nidorino),
    SPECIES_PAL(YOUMU, gMonPalette_Nidoking),
