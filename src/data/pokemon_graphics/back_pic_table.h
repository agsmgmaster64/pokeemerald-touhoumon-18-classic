const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(CLILYWHITE, gMonBackPic_Squirtle),
    SPECIES_SPRITE(LILYWHITE, gMonBackPic_Wartortle),
    SPECIES_SPRITE(CLILYBLACK, gMonBackPic_Blastoise),
    SPECIES_SPRITE(LILYBLACK, gMonBackPic_Caterpie),
    SPECIES_SPRITE(CMOMIJI, gMonBackPic_Metapod),
    SPECIES_SPRITE(MOMIJI, gMonBackPic_Butterfree),
    SPECIES_SPRITE(CSHIZUHA, gMonBackPic_Weedle),
    SPECIES_SPRITE(SHIZUHA, gMonBackPic_Kakuna),
    SPECIES_SPRITE(CMEDICINE, gMonBackPic_Beedrill),
    SPECIES_SPRITE(MEDICINE, gMonBackPic_Pidgey),
    SPECIES_SPRITE(CKOAKUMA, gMonBackPic_Pidgeotto),
    SPECIES_SPRITE(KOAKUMA, gMonBackPic_Pidgeot),
    SPECIES_SPRITE(CNAZRIN, gMonBackPic_Rattata),
    SPECIES_SPRITE(NAZRIN, gMonBackPic_Raticate),
    SPECIES_SPRITE(CTOKIKO, gMonBackPic_Spearow),
    SPECIES_SPRITE(TOKIKO, gMonBackPic_Fearow),
    SPECIES_SPRITE(CREMILIA, gMonBackPic_Ekans),
    SPECIES_SPRITE(REMILIA, gMonBackPic_Arbok),
    SPECIES_SPRITE(CCIRNO, gMonBackPic_Pikachu),
    ...
    SPECIES_SPRITE(CYOUMU, gMonBackPic_Nidorino),
