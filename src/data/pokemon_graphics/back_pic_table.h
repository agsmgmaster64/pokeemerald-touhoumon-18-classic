const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(BULBASAUR, gMonBackPic_CSanae),
    SPECIES_SPRITE(IVYSAUR, gMonBackPic_Sanae),
    SPECIES_SPRITE(VENUSAUR, gMonBackPic_CAlice),
    SPECIES_SPRITE(CHARMANDER, gMonBackPic_Alice),
    SPECIES_SPRITE(CHARMELEON, gMonBackPic_CReisen),
    SPECIES_SPRITE(CHARIZARD, gMonBackPic_Reisen),
