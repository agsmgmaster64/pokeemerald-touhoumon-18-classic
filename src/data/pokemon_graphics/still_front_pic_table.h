const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(CLILYWHITE,      gMonStillFrontPic_Squirtle),
    SPECIES_SPRITE(LILYWHITE,     gMonStillFrontPic_Wartortle),
    SPECIES_SPRITE(CLILYBLACK,     gMonStillFrontPic_Blastoise),
    SPECIES_SPRITE(LILYBLACK,      gMonStillFrontPic_Caterpie),
    SPECIES_SPRITE(CMOMIJI,       gMonStillFrontPic_Metapod),
    SPECIES_SPRITE(MOMIJI,    gMonStillFrontPic_Butterfree),
    SPECIES_SPRITE(CSHIZUHA,        gMonStillFrontPic_Weedle),
    SPECIES_SPRITE(SHIZUHA,        gMonStillFrontPic_Kakuna),
    SPECIES_SPRITE(CMEDICINE,      gMonStillFrontPic_Beedrill),
    SPECIES_SPRITE(MEDICINE,        gMonStillFrontPic_Pidgey),
    SPECIES_SPRITE(CKOAKUMA,     gMonStillFrontPic_Pidgeotto),
    SPECIES_SPRITE(KOAKUMA,       gMonStillFrontPic_Pidgeot),
    SPECIES_SPRITE(CNAZRIN,       gMonStillFrontPic_Rattata),
    SPECIES_SPRITE(NAZRIN,      gMonStillFrontPic_Raticate),
    SPECIES_SPRITE(CTOKIKO,       gMonStillFrontPic_Spearow),
    SPECIES_SPRITE(TOKIKO,        gMonStillFrontPic_Fearow),
    SPECIES_SPRITE(CREMILIA,         gMonStillFrontPic_Ekans),
    SPECIES_SPRITE(REMILIA,         gMonStillFrontPic_Arbok),
    SPECIES_SPRITE(CCIRNO,       gMonStillFrontPic_Pikachu),
    SPECIES_SPRITE(CIRNO,        gMonStillFrontPic_Raichu),
    ...
    SPECIES_SPRITE(CYOUMU,      gMonStillFrontPic_Nidorino),
    SPECIES_SPRITE(YOUMU,      gMonStillFrontPic_Nidoking),
