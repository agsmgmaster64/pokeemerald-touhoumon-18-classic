...
#define WEATHER_HAS_EFFECT ((!ABILITY_ON_FIELD(ABILITY_UNCONSCIOUS) && !ABILITY_ON_FIELD(ABILITY_HISOUTEN)))
#define WEATHER_HAS_EFFECT2 ((!ABILITY_ON_FIELD2(ABILITY_UNCONSCIOUS) && !ABILITY_ON_FIELD2(ABILITY_HISOUTEN)))
